"""
Pipeline Runner - Job Management cho Web API
============================================
Module này quản lý vòng đời jobs: tạo job, chạy pipeline trong background thread,
và gửi WebSocket updates realtime.

Pipeline thực tế được thực thi bởi main.process_video() — single source of truth.

Technology:
    Python 3.10 + FastAPI + WebSocket
"""
...
# Import các Stage để dùng trong emergency_clean_gpu()
...
def _run_pipeline_thread(job_id: str, skip_lipsync: bool,
    ...
    try:
        ...
        # Giải phóng VRAM khi pipeline crash
        _emergency_clean_gpu()
